...
1. Install [AFL] (https://github.com/google/AFL). you can directly download the zip, or use your package manager (`apt install afl` on Debian)
2. If you're building from source, compile it.  Read the `README.md` (but I'd just use a package manager).
3. you will see new binaries being created. We are interested in 2 of them-- `afl-fuzz` and `afl-clang`. type following to see if they are working:
...
5. Copy the above seed input into temp-in directory.
