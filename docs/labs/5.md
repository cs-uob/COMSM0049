...
1. Install [AFL] (https://github.com/google/AFL).  Unfortunately Debian's install is missing 32bit support (which we'll need later), so you'll have to build from source. You can directly download the zip.
