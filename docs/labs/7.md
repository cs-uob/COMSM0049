...
```
\*ls command is used to display the permissions of the files. 

See **man ls** if you need to know more about it.

Now, let's see what **ls -l/bin/ls** displays.

Try to understand what the permissions are and which user it belongs to and what is the hard link?
