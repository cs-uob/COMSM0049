...
3.  Now, login as abbott and try to create a file called abbott.txt in
    the costello important-files directory. Did it work? Why?

Remove the SUID configuration you added during task 2
and try again. Does it work now?

If not try to add a rule to the ACL of the folder costello important-files that
